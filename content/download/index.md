...
![](https://www.key-project.org/wp-content/uploads/2021/12/key-shadow-2.10.png)
...
- Single Click Jar: [key-2.10.0-exe.jar](https://www.key-project.org/dist/2.10.0/key-2.10.0-exe.jar) (officially supported install version)
  - Download and start via `java -jar key-2.10.0-exe.jar` or via a simple double click on the jar file
...
[our “Getting Help”
section](https://www.key-project.org/getting-started/).
